...
namespace FantasyDataAPI\Test\PlayerSeasonProjectionStatsByTeam;
...
class IntegrationTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testSuccessfulResponse()
    {
        ...
        $result = $client->PlayerSeasonProjectionStatsByTeam(['Season' => '2013REG', 'Team' => 'NE']);
    ...
    public function testInvalidAPIKey()
    {
        ...
        /** @var \GuzzleHttp\Command\Model $result */
        $client->PlayerSeasonProjectionStatsByTeam(['Season' => '2013REG', 'Team' => 'NE']);
    }
}
