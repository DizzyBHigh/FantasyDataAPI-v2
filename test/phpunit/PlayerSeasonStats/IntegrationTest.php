...
class PlayerSeasonStats extends PHPUnit_Framework_TestCase
{

    /**
     * Given: A developer API key
     * When: API is queried for PlayerSeasonStatsTest, Season 2013REG
    ...
    public function testSuccessfulResponse()
    {
        ...
        $result = $client->PlayerSeasonStats(['Season' => '2013REG']);
    ...
    public function testInvalidAPIKey()
    {
        ...
        /** @var \GuzzleHttp\Command\Model $result */
        $client->PlayerSeasonStats(['Season' => '2013REG']);
    }
}
