...
namespace FantasyDataAPI\Test\PlayerSeasonStats;
...
class UnitTest extends PHPUnit_Framework_TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        static::$sClient->PlayerSeasonStats(['Season' => '2013REG']);
    ...
    public function testResourceInURI()
    {
        ...
        $this->assertEquals( static::$sUrlFragments[6], 'PlayerSeasonStats');
    }
