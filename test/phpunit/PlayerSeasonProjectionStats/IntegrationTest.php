...
class PlayerSeasonProjectionStats extends PHPUnit_Framework_TestCase
{

    /**
     * Given: A developer API key
     * When: API is queried for PlayerSeasonProjectionStatsTest, Season 2013REG
     * Then: Expect a 200 response with an array entries that each contain PlayerSeason and Scoring Details
     *
     * @group Integration
     * @medium
     */
    public function testSuccessfulResponse()
    {
        ...
        $result = $client->PlayerSeasonProjectionStats(['Season' => '2013REG']);
        ...
        $check_player_game = function ( $pPlayerSeason )
        {
            /** we expect 127 stats */
     ...
     * When: API is queried for PlayerSeasonStatsByWeekTest, Season 2013REG, Week 17
    ...
    public function testInvalidAPIKey()
    {
        ...
        /** @var \GuzzleHttp\Command\Model $result */
        $client->PlayerSeasonProjectionStats(['Season' => '2013REG']);
    }
}
