...
namespace FantasyDataAPI\Test\RecentlyUpdatedBoxScores\Response;
...
class Mock extends Response
{
    ...
    public function __construct (RequestInterface $pRequest)
    {
         ...
         */
        list(, , ,$format,  ,  $minutes) = explode( '/', $pRequest->getPath() );
        /**  hard code subscription so we use same filenames!  */
        $subscription = 'developer';

        $file_partial = __DIR__ . '/' . implode('.', [$subscription, $format, $minutes]);
