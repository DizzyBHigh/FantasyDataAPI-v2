...
namespace FantasyDataAPI\Test\RecentlyUpdatedBoxScores;
...
class UnitTest extends PHPUnit_Framework_TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        static::$sClient->RecentlyUpdatedBoxScores([ 'Minutes' => '60' ]);
    ...
    public function testResourceInURI()
    {
        ...
        $this->assertEquals( static::$sUrlFragments[6], 'RecentlyUpdatedBoxScores');
    }
    ...
    public function testMinutesInURI()
    {
        ...
        list($minutes) = explode('?', static::$sUrlFragments[7]);
