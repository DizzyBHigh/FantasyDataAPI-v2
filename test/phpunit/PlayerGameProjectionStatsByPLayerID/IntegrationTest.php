...
namespace FantasyDataAPI\Test\PlayerGameProjectionStatsByPlayerID;
...
class IntegrationTest extends PHPUnit_Framework_TestCase
{
     ...
     * When: API is queried for 2013REG, Week 17, PlayerID 10974 PlayerGameProjectionStatsByPlayerID
     * Then: Expect a 200 response with an array entries that the PlayerGameProjectionStatsByPlayerID details
     *
     * @group Integration
     * @medium
     */
    public function testSuccessfulResponse()
    {
        ...
        $result = $client->PlayerGameProjectionStatsByPlayerID(['Season' => '2013REG', 'Week' => 13, 'PlayerID' => '10974']);
    ...
    public function testInvalidAPIKey()
    {
        ...
        /** @var \GuzzleHttp\Command\Model $result */
        $client->PlayerGameProjectionStatsByPlayerID(['Season' => '2013REG', 'Week' => 13, 'PlayerID' => '10974']);
    }
}
