...
class IntegrationTest extends PHPUnit_Framework_TestCase
{
     ...
     * Then: Expect a 200 response with an array entries that the PlayerGameProjectionStatsByWeek details
     *
     * @group Integration
     * @group AllTests
     * @medium
    ...
    public function testSuccessfulResponse()
    {
        ...
        $result = $client->PlayerGameProjectionStatsByWeek(['Season' => '2013REG', 'Week' => '17', 'Team' => 'NE']);
    ...
    public function testInvalidAPIKey()
    {
        ...
        /** @var \GuzzleHttp\Command\Model $result */
        $client->PlayerGameProjectionStatsByWeek(['Season' => '2013REG', 'Week' => '17', 'Team' => 'NE']);
    }
}
