...
class UnitTest extends PHPUnit_Framework_TestCase
{
     ...
     *   http://api.nfldata.apiphany.com/developer/json/FantasyPlayersByADP
     */
    public static function setUpBeforeClass()
    {
        ...
        static::$sClient->FantasyPlayersByADP([]);
     ...
     * Given: A developer API key
     * When: API is queried for FantasyPlayersByADP
     * Then: Expect that the FantasyPlayersByADP resource is placed in the URI
     *
     * @group Unit
     * @small
     */
    public function testResourceInURI()
    {
        ...
        /** Even though were pulling FantasyPLayersByADP the actual resource on fantasyDataAPI is "FantasyPLayers" */
