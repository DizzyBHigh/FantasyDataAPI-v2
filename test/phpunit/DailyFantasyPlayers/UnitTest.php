...
class UnitTest extends PHPUnit_Framework_TestCase
{
     ...
     *   http://api.nfldata.apiphany.com/developer/json/DailyFantasyPlayers/{Date}
     */
     ...
     * Given: A developer API key
     * When: API is queried for DailyFantasyPlayers
     * Then: Expect that the DailyFantasyPlayers resource is placed in the URI
     *
     * @group Unit
     * @small
     */
    public function testResourceInURI()
    {
        ...
        /** Even though were pulling FantasyPLayersByADP the actual resource on fantasyDataAPI is "DailyFantasyPLayers" */
        $this->assertEquals( $resource, 'DailyFantasyPlayers');
    }
